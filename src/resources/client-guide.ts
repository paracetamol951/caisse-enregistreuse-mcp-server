...
- name: first name
- surname: last name
- email: primary unique identifier � always search by email before creating (data_list_clients)
...
- clientGroupID: assign the customer to a group/segment (e.g. "VIP", "Wholesale")
  Retrieve available groups from data_list_clients or the back-office.
...
MUST:
1. Always call data_list_clients (filter by email) before creating a new client.
